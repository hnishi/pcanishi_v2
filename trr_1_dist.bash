...
icc trr_extr_dista.cpp quatnishi.cpp pdbnishi.cpp trr_tranishi.cpp inpnishi.cpp math_nishi.cpp -o trr_extr_dista.exe -I ~/nishitool/eigen-eigen-1306d75b4a21
